          ...
          <div className="phonesTabletsLeftBox">
            ...
            <div className="phonesTabletsLeft-FilterBox">
              ...
              <div className="phonesTabletsLeft-FilterBox-Select">
                <Checkbox style={{ color: "red" }}>DSLR</Checkbox>
                <Checkbox style={{ color: "red" }}>Action Camera</Checkbox>
                <Checkbox style={{ color: "red" }}>Web Camera</Checkbox>
                <Checkbox style={{ color: "red" }}>Security Camera</Checkbox>
                <Checkbox style={{ color: "red" }}>Accessories</Checkbox>
            ...
            {/* Accessories */}
            <div className="phonesTabletsLeft-FilterBox">
              <p className="phonesTabletsLeft-FilterBox-Text">Accessories</p>
              <div className="phonesTabletsLeft-FilterBox-Line" />
              <div className="phonesTabletsLeft-FilterBox-Select">
                <Checkbox style={{ color: "red" }}>Lens </Checkbox>
                <Checkbox style={{ color: "red" }}>Camera Kit </Checkbox>
                <Checkbox style={{ color: "red" }}>Stand</Checkbox>
                <Checkbox style={{ color: "red" }}>Tripod</Checkbox>
                <Checkbox style={{ color: "red" }}>Mobile Gimbal</Checkbox>
                <Checkbox style={{ color: "red" }}>Camera Gimbal</Checkbox>
              </div>
            </div>
