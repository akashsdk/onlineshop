        ...
        >
          <div className="phonesTabletsLeftBox">
            ...
            <div className="phonesTabletsLeft-FilterBox">
              ...
              <div className="phonesTabletsLeft-FilterBox-Select">
                <Checkbox style={{ color: "red" }}>Tab</Checkbox>
                <Checkbox style={{ color: "red" }}>iPad</Checkbox>
                <Checkbox style={{ color: "red" }}>Macbook</Checkbox>
                <Checkbox style={{ color: "red" }}>Mac</Checkbox>
                <Checkbox style={{ color: "red" }}>Laptop</Checkbox>
                <Checkbox style={{ color: "red" }}>Desktop</Checkbox>
                <Checkbox style={{ color: "red" }}>Other</Checkbox>
              </div>
            </div>
            ...
            <div className="phonesTabletsLeft-FilterBox">
              ...
              <div className="phonesTabletsLeft-FilterBox-Line" />
              <div className="phonesTabletsLeft-FilterBox-Select">
                <Checkbox style={{ color: "red" }}>Wireless</Checkbox>
                <Checkbox style={{ color: "red" }}>Wired</Checkbox>
              </div>
            </div>
            ...
            <div className="phonesTabletsLeft-FilterBox">
              ...
              <div className="phonesTabletsLeft-FilterBox-Line" />
              <div className="phonesTabletsLeft-FilterBox-Select">
                <Checkbox style={{ color: "red" }}>10 inch</Checkbox>
                <Checkbox style={{ color: "red" }}>11 inch</Checkbox>
                <Checkbox style={{ color: "red" }}>12 inch</Checkbox>
            ...
            <div className="phonesTabletsLeft-FilterBox">
              ...
              <div className="phonesTabletsLeft-FilterBox-Line" />
              <div className="phonesTabletsLeft-FilterBox-Select">
                <Checkbox style={{ color: "red" }}>2020</Checkbox>
                <Checkbox style={{ color: "red" }}>2021</Checkbox>
                <Checkbox style={{ color: "red" }}>2022</Checkbox>
                <Checkbox style={{ color: "red" }}>2023</Checkbox>
              </div>
            </div>
          ...
          <div className="phonesTabletsRightBox">
            ...
            <div className="phonesTabletsRight-Header">
              <h3 className="phonesTabletsRight-HeaderText">Keyboard</h3>
              {/* Filter */}
              <Button
