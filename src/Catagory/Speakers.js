        ...
        >
          <div className="phonesTabletsLeftBox">
            ...
            <div className="phonesTabletsLeft-FilterBox">
              ...
              <div className="phonesTabletsLeft-FilterBox-Select">
                <Checkbox style={{ color: "red" }}>Wired Speakers</Checkbox>
                <Checkbox style={{ color: "red" }}>Wireless Speakers</Checkbox>
                <Checkbox style={{ color: "red" }}>Bluetooth Speakers</Checkbox>
              </div>
            </div>
          ...
          <div className="phonesTabletsRightBox">
            ...
            <div className="phonesTabletsRight-Header">
              <h3 className="phonesTabletsRight-HeaderText">Speakers</h3>
              {/* Filter */}
              <Button
