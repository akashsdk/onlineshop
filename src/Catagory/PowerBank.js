      ...
      >
        <div className="phonesTabletsLeftBox">
          ...
          <div className="phonesTabletsLeft-FilterBox">
            ...
            <div className="phonesTabletsLeft-FilterBox-Select">
              <Checkbox style={{ color: "red" }}>1m</Checkbox>
              <Checkbox style={{ color: "red" }}>2m</Checkbox>
              <Checkbox style={{ color: "red" }}>3 feet</Checkbox>
              <Checkbox style={{ color: "red" }}>3m</Checkbox>
              <Checkbox style={{ color: "red" }}>5m</Checkbox>
              <Checkbox style={{ color: "red" }}>6 feet</Checkbox>
            </div>
          </div>
          ...
          <div className="phonesTabletsLeft-FilterBox">
            ...
            <div className="phonesTabletsLeft-FilterBox-Line" />
            <div className="phonesTabletsLeft-FilterBox-Select">
              <Checkbox style={{ color: "red" }}>Micro-USB</Checkbox>
              <Checkbox style={{ color: "red" }}>Type-C</Checkbox>
            </div>
          </div>
          ...
          {/* Capacity */}
          <div className="phonesTabletsLeft-FilterBox">
            <p className="phonesTabletsLeft-FilterBox-Text">Capacity</p>
            <div className="phonesTabletsLeft-FilterBox-Line" />
            <div className="phonesTabletsLeft-FilterBox-Select">
              <Checkbox style={{ color: "red" }}>10000mAh</Checkbox>
              <Checkbox style={{ color: "red" }}>20000mAh</Checkbox>
              <Checkbox style={{ color: "red" }}>30000mAh</Checkbox>
            </div>
          </div>

          {/* Plug */}
          <div className="phonesTabletsLeft-FilterBox">
            <p className="phonesTabletsLeft-FilterBox-Text">Plug</p>
            <div className="phonesTabletsLeft-FilterBox-Line" />
            <div className="phonesTabletsLeft-FilterBox-Select">
              <Checkbox style={{ color: "red" }}>2 Pin</Checkbox>
              <Checkbox style={{ color: "red" }}>3 Pin</Checkbox>
              <Checkbox style={{ color: "red" }}>Lighting</Checkbox>
              <Checkbox style={{ color: "red" }}>Micro USB</Checkbox>
              <Checkbox style={{ color: "red" }}>Type-C</Checkbox>
            </div>
          </div>
        ...
        <div className="phonesTabletsRightBox">
          ...
          <div className="phonesTabletsRight-Header">
            <h3 className="phonesTabletsRight-HeaderText">PowerBank & Adapter</h3>
            {/* Filter */}
            <Button
