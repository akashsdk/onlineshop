        ...
        >
          <div className="phonesTabletsLeftBox">
            ...
            <div className="phonesTabletsLeft-FilterBox">
              ...
              <div className="phonesTabletsLeft-FilterBox-Select">
                <Checkbox style={{ color: "red" }}>Airpods</Checkbox>
                <Checkbox style={{ color: "red" }}>
                  Overhead Headphones
                </Checkbox>
                <Checkbox style={{ color: "red" }}>Wired Headphone</Checkbox>
                <Checkbox style={{ color: "red" }}>Wireless Headphone</Checkbox>
              </div>
            </div>
          ...
          <div className="phonesTabletsRightBox">
            ...
            <div className="phonesTabletsRight-Header">
              <h3 className="phonesTabletsRight-HeaderText">Headphones</h3>
              {/* Filter */}
              <Button
